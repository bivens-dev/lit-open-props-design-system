...
import { styles } from './lib/filled-button.styles.js';
/**
 * An elevated button that is filled with a color.
 *
...
FilledButton.styles = [sharedStyles, elevationStyles, styles];
if (!customElements.get('my-filled-button')) {
    customElements.define('my-filled-button', FilledButton);
}
